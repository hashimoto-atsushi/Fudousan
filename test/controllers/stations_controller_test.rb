...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { apartment_id: @station.apartment_id, station_name: @station.station_name, train_line: @station.train_line, walk_time: @station.walk_time } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { apartment_id: @station.apartment_id, station_name: @station.station_name, train_line: @station.train_line, walk_time: @station.walk_time } }
